    ...
    <nav class="navbar">
        <div class="container">
            <div class="navbar-container">
                <a href="/" class="logo">Arthur Kershaw Funeral Services</a>
                ...
                <ul class="nav-menu">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="dropdown">
                            <a href="/service-traditional-burial.php">Traditional Burial</a>
                            <a href="/service-cremation.php">Cremation Service</a>
                            <a href="/service-direct-cremation.php">Direct Cremation</a>
                            <a href="/pre-paid-plans.php">Pre-Paid Funeral Plans</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link">Locations <i class="fas fa-chevron-down"></i></a>
                        <div class="dropdown">
                            <a href="/funeral-directors-sale.php">Sale</a>
                            <a href="/funeral-directors-stretford.php">Stretford</a>
                            <a href="/funeral-directors-altrincham.php">Altrincham</a>
                            <a href="/funeral-directors-timperley.php">Timperley</a>
                            <a href="/funeral-directors-ashton-upon-mersey.php">Ashton-Upon-Mersey</a>
                            <a href="/funeral-directors-hale.php">Hale</a>
                            <a href="/funeral-directors-lymm.php">Lymm</a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a href="#" class="nav-link">Information <i class="fas fa-chevron-down"></i></a>
                        <div class="dropdown">
                            <a href="/funeral-costs.php">Funeral Costs</a>
                            <a href="/arranging-a-funeral.php">Arranging a Funeral</a>
                            <a href="/faqs.php">FAQs</a>
                            <a href="/testimonials.php">Testimonials</a>
                            <a href="/funeral-notices.php">Funeral Notices</a>
                        </div>
                    </li>
                    <li class="nav-item">
