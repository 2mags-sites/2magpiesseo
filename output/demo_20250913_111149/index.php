        ...
        <section class="hero">
            <div class="container">
                ...
                <div class="hero-buttons">
                    <a href="<?php echo get_url('/contact'); ?>" class="btn btn-primary"><?php echo e($content['hero']['cta_primary']); ?></a>
                    <a href="<?php echo get_url('/about'); ?>" class="btn btn-secondary"><?php echo e($content['hero']['cta_secondary']); ?></a>
                </div>
            </div>
        </section>
        <?php endif; ?>
            ...
            <div class="container">
                ...
                <div class="services-grid">
                    ...
                    <div class="service-card">
                        ...
                        <a href="<?php echo get_url($service['link']); ?>" class="btn-link">Learn More →</a>
                        <?php endif; ?>
                    </div>
                    <?php endforeach; ?>
                </div>
